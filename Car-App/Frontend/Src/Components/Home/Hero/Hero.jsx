    ...
    <div className=" bg-black text-white">
      <div className=" h-screen container flex flex-col justify-center md:flex-row items-center">
        ...
        <div className=" w-full md:w-2/4 space-y-5 mt-10">
          ...
          Discover the latest car models with detailed specifications, pricing, and high-quality images.
          </p>
          ...
          <div className="flex gap-8">
            ...
            <button className="border-2 border-primary py-1 px-4 rounded-md hover:bg-primary transition duration-200 ease-linear" onClick={() => navigate('/ourCars')} >
              See Cars
            </button>
          </div>
        </div>
